...
class Examples extends MY_Controller
{
	...
	public function index()
	{
		if( $this->require_role('admin') )
		{
			...
			echo '<p> Welcome to the Employee Management App! </p>';

			//echo anchor( site_url('main/employees', $link_protocol ),'Go to Employees Dashboard');
		 	//echo $this->load->view('main/employees', '', TRUE);
	...
	public function ajax_login()
	{
						...
						success: function(response){
							...
							if(response.status == 1){
								$('form').replaceWith('<p>You are now logged in.</p>
													<p>echo anchor( site_url('main/employees', $link_protocol ),'Go to Employees Dashboard');</p>');
		...
		//$html .=$this->load->view('main/employees', $data, TRUE);
		//echo anchor( site_url('main/employees', $link_protocol ),'Go to Employees Dashboard');
		$html .= $this->load->view('examples/page_footer', '', TRUE);
